...
elseif &background == "dark"
    hi Boolean gui=NONE guifg=#b1833e guibg=NONE
    hi ColorColumn gui=NONE guifg=NONE guibg=#1a1a1a
    hi Comment gui=NONE guifg=#90ab87 guibg=NONE
    hi Conceal gui=NONE guifg=#808080 guibg=NONE
    hi Conditional gui=NONE guifg=#71a5d6 guibg=NONE
    ...
    hi Normal gui=NONE guifg=#c7c7c7 guibg=#19191f
    hi Number gui=NONE guifg=#ee8a8a guibg=NONE
    ...
    hi Special gui=NONE guifg=#e382bf guibg=NONE
    ...
    hi Statement gui=NONE guifg=#71a5d6 guibg=NONE
    hi StatusLine gui=NONE guifg=#9e9e9e guibg=#262626
    hi StatusLineNC gui=NONE guifg=#707070 guibg=#262626
    hi StorageClass gui=NONE guifg=#71a5d6 guibg=NONE
    hi String gui=NONE guifg=#ddb77e guibg=NONE
    ...
    hi Title gui=NONE guifg=#d1d1d1 guibg=NONE
    hi Todo gui=standout guifg=NONE guibg=NONE
    hi Type gui=NONE guifg=#e382bf guibg=NONE
    hi Underlined gui=NONE guifg=NONE guibg=NONE
    ...
    hi lCursor gui=NONE guifg=NONE guibg=NONE
    hi Identifier gui=NONE guifg=NONE guibg=NONE
    hi PreProc gui=NONE guifg=#6fa3d5 guibg=NONE
endif
